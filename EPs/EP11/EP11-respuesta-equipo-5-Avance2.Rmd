...
summary(modelo)
```
Se observa que el modelo tiene $R^2 \approx 0.9695$ y un $R_{adj}^2 \approx 0.969$, esto significa que el modelo explica aproximadamente el 96.95% de la variabilidad de la variable Peso (Weight) a partir de las variables predictoras seleccionadas. Esto indica un ajuste muy bueno del modelo a los datos.
